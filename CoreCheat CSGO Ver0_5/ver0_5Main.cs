...
using CylMem = CoreCheat_CSGO_Ver0_5.Class_Memory;

namespace CoreCheat_CSGO_Ver0_5
{
    //Hi From Cylops. You should Credit if you want to use that shitty Soruce! Also you should use your own fuckn memory class!
